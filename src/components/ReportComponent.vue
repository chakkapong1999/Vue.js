<template>
  <div class="container">
    ...
    <div class="grid-item7">
      <h3>สะสม 100% ของประชากร</h3>
      <p>
        นับเฉพาะเข็มแรกฉีดแล้ว {{ formatNumber(1000000) }} คน
...
.grid-item3 {
  grid-column: 1/3;
  text-indent: 20px;
  background: rgba(122, 165, 179, 0.7);
}
.grid-item4 {
  grid-column: 3/5;
  text-indent: 20px;
  background: rgba(99, 177, 110, 0.8);
}
.grid-item5 {
  grid-column: 1/3;
  text-indent: 20px;
  background: rgba(191, 170, 104, 0.8);
}
.grid-item6 {
  grid-column: 3/5;
  text-indent: 20px;
...
.total2 {
  overflow: auto;
  background: rgba(86, 82, 91, 0.8);
}
.total3 {
  overflow: auto;
  background: rgba(100, 125, 132, 0.8);
}
.total4 {
  overflow: auto;
  background: rgba(87, 133, 91, 0.8);
}
.total5-6 {
  overflow: auto;
  background: rgba(135, 132, 94, 0.8);
}
</style>